...
import com.alan.slidingmenu.Fragment.SectionPagerAdapterAide;
...
public class AideActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager.setAdapter(new SectionPagerAdapterAide(getSupportFragmentManager()));
